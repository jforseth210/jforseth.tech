...
def barrel_racing_counter():
    ...
    try:
        ...
        flash(
            "Current number is not a number! Please type in a number.", category="alert"
        )
        return render_template(
            "barrel_racing/barrel_racing_counter.html", current_number="ERROR"
        )
    return render_template(
        "barrel_racing/barrel_racing_counter.html", current_number=current_number
    )
